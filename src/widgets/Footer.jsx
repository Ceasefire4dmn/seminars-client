        ...
        <Nav className="justify-content-center align-items-center py-3">
            ...
            <Nav.Item>
                <Nav.Link style={{ color: "#ffffff" }}  href="https://github.com/Ceasefire4dmn" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="currentColor" className="bi bi-github me-1" viewBox="0 0 16 16">
            ...
            <Nav.Item>
                <Nav.Link style={{ color: "#ffffff" }} href="http://www.linkedin.com/in/aleksandra-trunova-9538bb325" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="currentColor" className="bi bi-linkedin me-1" viewBox="0 0 16 16">
